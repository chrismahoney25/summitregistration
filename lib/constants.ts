import { RegistrationTypeOption } from './types'

export const REGISTRATION_TYPES: RegistrationTypeOption[] = [
  {
    id: 'non-level-member',
    name: 'Non-Level Member',
    price: 2750,
    attendees: 2,
    description: 'For salons not yet on Level',
  },
  {
    id: 'level-member',
    name: 'Level Member',
    price: 1950,
    attendees: 2,
    description: 'For active Level subscribers',
  },
  {
    id: 'level-member-solo',
    name: 'Level Member Solo',
    price: 1450,
    attendees: 1,
  ...
  },
  {
    ...
    price: 1250,
    attendees: 2,
    description: 'For previous summit attendees',
  },
]
